/*
  This is the initial ios app extension view controller, which is referenced by OctetViolins-iOS-MainInterface storyboard
*/

import UIKit
import CoreAudioKit

public class OctetViolinsViewController: AUViewController {
  ...
  func connectViewWithAU() {
    // To use the generic UI (swift), change the view in OctetViolins-iOS-MainInterface.storyboard to custom class: GenericUI  module: OctetViolinsFramework
