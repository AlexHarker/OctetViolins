...
def main():
  ...
  plistpath = scriptpath + "/resources/OctetViolins-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OctetViolins-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OctetViolins-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OctetViolins-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OctetViolins-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/OctetViolins-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/OctetViolins-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/OctetViolins.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/OctetViolins.iss",inplace=1):
