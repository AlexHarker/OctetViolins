...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=OctetViolins Demo Installer\n"
      else:
        line="OutputBaseFilename=OctetViolins Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the OctetViolins Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the OctetViolins installer\n"

    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=OctetViolins Demo installer\n"
     else:
       line="SetupWindowTitle=OctetViolins installer\n"
